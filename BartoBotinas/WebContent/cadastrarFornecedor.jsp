...
<body>
	...
	<main class="bartoMain">
		<form action="cadastrarFornecedor" method="post" class="bartoForm">
			<div>
				<label for="nome"><strong>Nome:</strong></label> <input type="text"
					id="nome" name="nome" placeholder="Nome do fornecedor" required>
			</div>
			<div>
				<label for="cnpj"><strong>CNPJ:</strong></label> <input type="text"
					id="cnpj" name="cnpj" placeholder="CNPJ do fornecedor" required>
			</div>
			<div>
