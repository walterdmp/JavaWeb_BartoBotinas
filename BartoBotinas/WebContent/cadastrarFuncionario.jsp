...
<meta charset="UTF-8">
<title>Bartô Botinas - Funcionários</title>
</head>
<body>
	<nav class="bartoNav">
		<ul>
	...
	<main class="bartoMain">
		<form action="cadastrarFuncionario" method="post" class="bartoForm">
			<div>
				<label for="nome"><strong>Nome:</strong></label> <input type="text"
					id="nome" name="nome" placeholder="Nome do funcionário" required>
			</div>
			<div>
				<label for="telefone"><strong>Telefone:</strong></label> <input
					type="text" id="telefone" name="telefone"
					placeholder="Telefone do funcionário" pattern="\d+"
					title="Digite apenas números" required>
			</div>

			<div>
				<label for="cargo"><strong>Cargo:</strong></label> <input
					type="text" id="cargo" name="cargo"
					placeholder="Cargo do funcionário" required>
			</div>
			<div>
				<label for="salario"><strong>Salário:</strong></label> <input
					type="number" id="salario" name="salario"
					placeholder="Salário do funcionário" required step="0.01" min="0">
			</div>
