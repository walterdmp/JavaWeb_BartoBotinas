...
public class CaixaDao {
	public void cadastrarCaixa(Caixa caixa) {
		String sql = "INSERT INTO caixa VALUES (null,?,?,?,?)";
		...
		try {
			...
			pStatement.setString(1, caixa.getTipo());
			pStatement.setFloat(2, caixa.getValor());
			pStatement.setString(3, caixa.getDescricao());
			pStatement.setDate(4, (Date) caixa.getData());
